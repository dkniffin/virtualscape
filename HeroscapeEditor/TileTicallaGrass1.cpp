// TileTicallaGrass1.cpp : implementation file
//
...
// The constructor
//
CTileTicallaGrass1::CTileTicallaGrass1()
{
	m_NbTile = 1;
	m_TileHeight = TILE3D_ZHEIGHT;
	m_Type = TYPE_TICALLA*1000+m_NbTile+1;
	m_TileColor = RGB(255,255,0);
	int CurrentPos = 0;
...
//
CTile* CTileTicallaGrass1::GetCopy()
{
...
// Draw more on a tile
//
void CTileTicallaGrass1::DrawExtend( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
	CFont Font;
...
//
void CTileTicallaGrass1::Render1( void* pView, bool ForShadow, bool BindTexture )
{
	...
	((CHeroscapeEditor3DView*) pView)->m_pTicallaGrass1->Render( BindTexture );
