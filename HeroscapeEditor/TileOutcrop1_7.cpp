// TileOutcrop1_7.cpp : implementation file
//
...
// The constructor
//
CTileOutcrop1_7::CTileOutcrop1_7()
{
	m_NbTile = 1;
...
// Draw more on a tile
//
void CTileOutcrop1_7::DrawExtend( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
	CFont Font;
...
//
void CTileOutcrop1_7::Render1( void* pView, bool ForShadow, bool BindTexture )
{
	...
	((CHeroscapeEditor3DView*) pView)->m_pOutcrop1->Render( BindTexture );
