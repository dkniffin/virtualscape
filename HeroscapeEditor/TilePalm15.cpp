// TilePalm15.cpp : implementation file
//
...
// The constructor
//
CTilePalm15::CTilePalm15()
{
	m_NbTile = 1;
	m_TileHeight = TILE3D_ZHEIGHT;
	m_Type = TYPE_TICALLA*1000+15;
...
// Draw more on a tile
//
void CTilePalm15::DrawExtend( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
	CFont Font;
...
//
void CTilePalm15::Render1( void* pView, bool ForShadow, bool BindTexture )
{
