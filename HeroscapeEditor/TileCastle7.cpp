...
//
CTile* CTileCastle7::GetCopy()
{
	CTileCastle7* pTile = new CTileCastle7;
...
//
void CTileCastle7::OnRotationChange()
{
	int CurrentPos = 0;
...
// Draw more on a tile
//
void CTileCastle7::DrawExtendTile( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
	POINT Points[10];
...
//
void CTileCastle7::VerifySomethingUnderTile( void* pTheDoc )
{
}
