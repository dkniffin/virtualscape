...
// The constructor
//
CTileMarvelWall6Breaked::CTileMarvelWall6Breaked()
{
	m_NbTile = 6;
	m_TileHeight = TILE3D_ZHEIGHT;
	m_Type = TYPE_RUIN*1000+m_NbTile+1;
...
//
CTile* CTileMarvelWall6Breaked::GetCopy()
{
...
//
void CTileMarvelWall6Breaked::OnRotationChange()
{
	int CurrentPos = 0;
...
// Draw more on a tile
//
void CTileMarvelWall6Breaked::DrawExtend( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
...
//
void CTileMarvelWall6Breaked::Render1( void* pView, bool ForShadow, bool BindTexture )
{
	...
	((CHeroscapeEditor3DView*) pView)->m_pMarvelRuin6Breaked->Render( BindTexture );
