// TileDungeon2.cpp : implementation file
//
...
//
void CTileDungeon2::OnRotationChange()
{
	int CurrentPos = 0;
...
// Draw more on a tile
//
void CTileDungeon2::DrawExtendTile( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
	POINT Points[10];
