#ifndef _TODEDICATEDSERVERSOCKET_H_
#define _TODEDICATEDSERVERSOCKET_H_

class CToDedicatedServerSocket : public CSocket
{
//*************
// The defines
//*************
...
public:
	// The constructor
	CToDedicatedServerSocket();
	// The destructor
	virtual ~CToDedicatedServerSocket();
...
public:
	...
	//{{AFX_VIRTUAL(CToDedicatedServerSocket)
	public:
	...
	//{{AFX_MSG(CToDedicatedServerSocket)
...
#endif // #ifndef _TODEDICATEDSERVERSOCKET_H_
