// TileGlacier3.cpp : implementation file
//
...
//
void CTileGlacier3::OnRotationChange()
{
	int CurrentPos = 0;
...
// Draw more on a tile
//
void CTileGlacier3::DrawExtend( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
	CFont Font;
...
//
void CTileGlacier3::Render1( void* pView, bool ForShadow, bool BindTexture )
{
	...
	((CHeroscapeEditor3DView*) pView)->m_pGlacier3->Render( BindTexture );
