// TileCastleWallStraight.cpp : implementation file
//
...
// The constructor
//
CTileCastleWallStraight::CTileCastleWallStraight()
{
	m_NbTile = 1;
	m_TileHeight = TILE3D_ZHEIGHT;
	m_Type = TYPE_CASTLE*1000+202;
...
//
CTile* CTileCastleWallStraight::GetCopy()
{
...
// Draw the tiles
//
void CTileCastleWallStraight::Draw( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
...
// Draw the tiles
//
void CTileCastleWallStraight::DrawSurround( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
	// Compute polyline around tiles
	POINT	Points1[7];
	POINT	Points2[7];
...
// Draw more on a tile
//
void CTileCastleWallStraight::DrawExtend( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
	CFont Font;
...
//
void CTileCastleWallStraight::Render1( void* pView, bool ForShadow, bool BindTexture )
{
	...
	((CHeroscapeEditor3DView*) pView)->m_pCastleWallStraight->Render( BindTexture );
...
//
void CTileCastleWallStraight::VerifySomethingUnderTile( void* pTheDoc )
{
}

// Fill the members with members of an other tile
//
void CTileCastleWallStraight::FillCopy( CTile* pTile )
{
	CTile::FillCopy( pTile );
	m_TileColor2 = ((CTileCastleWallStraight*) pTile)->m_TileColor2;
}
