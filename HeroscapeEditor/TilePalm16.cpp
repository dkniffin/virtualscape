// TilePalm16.cpp : implementation file
//
...
// The constructor
//
CTilePalm16::CTilePalm16()
{
	m_NbTile = 1;
	m_TileHeight = TILE3D_ZHEIGHT;
	m_Type = TYPE_TICALLA*1000+16;
...
// Draw more on a tile
//
void CTilePalm16::DrawExtend( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
	CFont Font;
	...
	pDC->DrawText( _T("16"), CRect(CenterX-x3,CenterY-x3,CenterX+x3,CenterY+x3), DT_CENTER | DT_VCENTER | DT_SINGLELINE );
...
//
void CTilePalm16::Render1( void* pView, bool ForShadow, bool BindTexture )
{
