// TileCastleArch.cpp : implementation file
//
...
// The constructor
//
CTileCastleArch::CTileCastleArch()
{
	m_NbTile = 3;
	m_Type = TYPE_CASTLE*1000+404;
...
//
void CTileCastleArch::OnRotationChange()
{
	int CurrentPos = 0;
...
// Draw the tiles
//
void CTileCastleArch::Draw( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
...
// Render a tile
//
void CTileCastleArch::Render1( void* pView, bool ForShadow, bool BindTexture )
{
	...
	((CHeroscapeEditor3DView*) pView)->m_pCastleArch->Render( BindTexture );
...
//
void CTileCastleArch::FillCopy( CTile* pTile )
{
	CTile::FillCopy( pTile );
	m_TileColor2 = ((CTileCastleArch*) pTile)->m_TileColor2;
}
