// TileTree1_11.cpp : implementation file
//
...
// The constructor
//
CTileTree1_11::CTileTree1_11()
{
	m_NbTile = 1;
	m_TileHeight = TILE3D_ZHEIGHT2;
	m_Type = TYPE_TREE*1000+m_NbTile+11;
...
// Draw more on a tile
//
void CTileTree1_11::DrawExtend( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
	CFont Font;
	...
	pDC->DrawText( _T("11"), CRect(CenterX-x3,CenterY-x3,CenterX+x3,CenterY+x3), DT_CENTER | DT_VCENTER | DT_SINGLELINE );
...
//
void CTileTree1_11::Render1( void* pView, bool ForShadow, bool BindTexture )
{
	...
	((CHeroscapeEditor3DView*) pView)->m_pTree11->Render( BindTexture );
