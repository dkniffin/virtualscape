// TileCastleBaseEnd.cpp : implementation file
//
...
// The constructor
//
CTileCastleBaseEnd::CTileCastleBaseEnd()
{
	m_NbTile = 1;
	m_TileHeight = TILE3D_ZHEIGHT2;
	m_Type = TYPE_CASTLE*1000+103;
...
//
CTile* CTileCastleBaseEnd::GetCopy()
{
...
// Draw the tiles
//
void CTileCastleBaseEnd::Draw( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
...
// Draw the tiles
//
void CTileCastleBaseEnd::DrawSurround( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
	// Compute polyline around tiles
	POINT	Points1[13];
	int		NbPoint1 = 13;
...
// Draw more on a tile
//
void CTileCastleBaseEnd::DrawExtend( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
	double LowColor = GetLowColor( DrawingLevel );
...
//
void CTileCastleBaseEnd::Render1( void* pView, bool ForShadow, bool BindTexture )
{
	...
	((CHeroscapeEditor3DView*) pView)->m_pCastleBaseEnd->Render( BindTexture );
...
//
void CTileCastleBaseEnd::FillCopy( CTile* pTile )
{
	CTile::FillCopy( pTile );
	m_TileColor2 = ((CTileCastleBaseEnd*) pTile)->m_TileColor2;
}
