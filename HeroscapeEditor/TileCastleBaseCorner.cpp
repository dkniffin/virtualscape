// TileCastleBaseCorner.cpp : implementation file
//
...
// The constructor
//
CTileCastleBaseCorner::CTileCastleBaseCorner()
{
	m_NbTile = 1;
	m_TileHeight = TILE3D_ZHEIGHT2;
	m_Type = TYPE_CASTLE*1000+101;
...
//
CTile* CTileCastleBaseCorner::GetCopy()
{
...
// Draw the tiles
//
void CTileCastleBaseCorner::Draw( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
...
// Draw the tiles
//
void CTileCastleBaseCorner::DrawSurround( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
	// Compute polyline around tiles
	POINT	Points1[9];
	POINT	Points2[5];
...
// Draw more on a tile
//
void CTileCastleBaseCorner::DrawExtend( CDC* pDC, int x, int y, int x2, int x3, int y2, int y3, int y4, int DrawingLevel)
{
	CFont Font;
...
//
void CTileCastleBaseCorner::Render1( void* pView, bool ForShadow, bool BindTexture )
{
	...
	((CHeroscapeEditor3DView*) pView)->m_pCastleBaseCorner->Render( BindTexture );
...
//
void CTileCastleBaseCorner::FillCopy( CTile* pTile )
{
	CTile::FillCopy( pTile );
	m_TileColor2 = ((CTileCastleBaseCorner*) pTile)->m_TileColor2;
}
